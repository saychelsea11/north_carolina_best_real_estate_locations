...
if st.button('Enter'):
    ...
    st.write("")
    df_zillow_sorted = sort_data_by_count(df_zillow,"EndPrice($)").drop('index',axis=1).reset_index()
    ...
    st.write("")
    df_zillow_sorted = sort_data_by_count(df_zillow,"PriceIncreasePerc(%)").drop('index',axis=1).reset_index()
    st.dataframe(df_zillow_sorted)
    ...
    st.write("")
    df_zillow_sorted = sort_data_by_count(df_zillow,"ReturnOnInvestment($)").drop('index',axis=1).reset_index()
    st.dataframe(df_zillow_sorted)
    ...
    st.write("")
    df_zillow_sorted = sort_data_by_count(df_zillow,"RateOfReturn(%)").drop('index',axis=1).reset_index()
    st.dataframe(df_zillow_sorted)
